 ...
 */
function createSumGrid(solution, lowerbound, upperbound, levelLength, nbCols = 3) {
 ...
 * @param {*} nbCols - The amount of columns on the grid, default: 3
 */
function getSubtractionRow(solution, lowerbound, upperbound, nbCols = 3) {
    if (solution === undefined || solution === null || solution === -1) {
...
* @param {*} nbCols - The width of the grid, default: 3
*/
function createSubtractionGrid(solution, lowerbound, upperbound, levelLength, nbCols = 3) {
...
* @param {*} nbCols - The width of the grid, default: 3
*/
function createMixedGrid(solution, lowerbound, upperbound, levelLength, nbCols = 3) {
 ...
 * @param {*} nbCols - The amount of columns on the grid, default: 3
 */
function getMultiplicationRow(solution, lowerbound, upperbound, nbCols = 3) {
 ...
 * @param {*} nbCols - The width of the grid, default: 3
 */
function createMultiplicationGrid(solution, lowerbound, upperbound, levelLength, nbCols = 3) {
 ...
 * @param {*} nbCols - The width of the grid, default: 3
 */
function getRandomGridByDiffClassic(level, nbCols = 3) {
 ...
 * @param {*} nbCols - The width of the grid, default: 3
 */
function getRandomGridByDiffEndurance(level, nbCols = 3) {
    // round levelLength parameter with arbitrary formula
...
function getRandomGridByGameType(gameType, level) {
    switch(gameType) {
        case 0:
